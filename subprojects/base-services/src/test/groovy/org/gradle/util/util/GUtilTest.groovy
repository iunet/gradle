...
public class GUtilTest extends spock.lang.Specification {
    ...
    def "reports available enum values for non convertible strings"() {
        ...
        then:
        def e = thrown(IllegalArgumentException)
        e.message == "Cannot convert string value '$value' to an enum value of type 'org.gradle.util.GUtilTest\$TestEnum' (valid case insensitive values: ENUM1, ENUM2, ENUM3, ENUM_4_1)"
